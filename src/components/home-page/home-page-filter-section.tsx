...
export const FilterSectionItem = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`my-inter inline-flex items-center justify-center gap-px px-3 py-2.5 mb-[12px] mr-[8px] relative bg-white rounded-[36px] border-[0.5px] border-solid 
            ${
              isSelected ? "border-blue-600" : "border-black text-black"
            } cursor-pointer`}
    >
